	...
	<div class="container-fluid text-center">    
		<div class="row content">
		    ...
		    <!--repeat for each row fetched by LoginController -->
		      <c:forEach items="${mostReviewedPolls}" var="mostReview">
			      <p class = "datecreated">Created on : <c:out value="${mostReview.dateCreated}" /> , Created by : <a href="#"><c:out value="${mostReview.createrName}" /></a></p>
			      <p class = "pollname"><strong><c:out value ="${mostReview.pollname}" /></strong></strong> <span class="badge"><c:out value="${mostReview.avgRating}" /></span></p>
			      <p><c:out value="${mostReview.polldesc}" /></p>
			      <p><a href ="#"><c:out value="${mostReview.weblink}" /></a></p>
			      <a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${mostReview.pollid}"/>"><button id ="totalreviews" class="btn btn-success" type="button">Total Reviews <span class="badge"><c:out value="${mostReview.totalRatings}" /></span></button></a>
			      <a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${mostReview.pollid}"/>"><button id = "writereview" class="btn btn-primary" type="button">Write a Review</button></a>
			      <hr>
		      </c:forEach>
		    </div>
