	...
	<div class="row content">
	    ...
	    <!--repeat for each row fetched by LoginController -->
	      <c:forEach items="${polls}" var="poll">
	          <p class = "datecreated">Created on : <c:out value="${poll.dateCreated}" /> , Created by : <a href="#"><c:out value="${poll.createrName}" /></a></p>
		      <p class = "pollname"><strong><c:out value ="${poll.pollname}" /></strong> <span class="badge"><c:out value="${poll.avgRating}" /></span></p>
		      <p><c:out value="${poll.polldesc}" /></p>
		      <p><a href ="#"><c:out value="${poll.weblink}" /></a></p>
		      <a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${poll.pollid}"/>"><button id ="totalreviews" class="btn btn-success" type="button">Total Reviews <span class="badge"><c:out value="${poll.totalRatings}" /></span></button></a>
		      <a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${poll.pollid}"/>"><button id = "writereview" class="btn btn-primary" type="button">Write a Review</button></a>
		      <hr>
	      </c:forEach>
	    </div>
