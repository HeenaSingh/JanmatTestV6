	...
	<div class="container-fluid text-center">    
		<div class="row content">
			...
			<div class="col-sm-6 text-left" style="padding-top:20px;"> <!--* Main Content Here -->
				...
				<c:forEach items="${createdByMe}" var="createdByMe">
				<p class = "datecreated">Created on : <c:out value="${createdByMe.dateCreated}" /> , Created by : <a href="#"><c:out value="${createdByMe.createrName}" /></a></p>
				<p class = "pollname"><strong><c:out value ="${createdByMe.pollname}" /></strong></strong> <span class="badge"><c:out value="${createdByMe.avgRating}" /></span></p>
				<p><c:out value="${createdByMe.polldesc}" /></p>
				<p><a href ="#"><c:out value="${createdByMe.weblink}" /></a></p>
				<a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${createdByMe.pollid}"/>"><button id ="totalreviews" class="btn btn-success" type="button">Total Reviews <span class="badge"><c:out value="${createdByMe.totalRatings}" /></span></button></a>
	            <a href="TotalReviews?submit=totalReviews&pollid=<c:out value="${createdByMe.pollid}"/>"><button id = "writereview" class="btn btn-primary" type="button">Write a Review</button></a>
		        <hr>
				</c:forEach>
			</div>
