	...
	<div class="container-fluid text-center">    
		<div class="row content">
			...
			<div class="col-sm-6 text-left" style="padding-top:20px;"> <!--* Main form here -->
				<form class="form-horizontal" method ="post" action="createNewPoll">
					<fieldset>
					<!-- Form Name -->
						<legend style="color:purple">Ask for reviews on almost anything....</legend>
					<!-- Text input-->
						<div class="form-group">
							<div style="margin:15px;">
								<input id="pollname" name="pollname" placeholder="" class="form-control input-md" required="" type="text">
								<span class="help-block">Enter name of something you are asking a review for</span>  
							</div>
						</div>
					<!-- Text input-->
						<div class="form-group">
							<div style="margin:15px;">
								<textarea id="polldesc" name="polldesc" placeholder="" class="form-control input-md" required="" type="text"></textarea>
								<span class="help-block">Please provide some more description here</span>  
							</div>
						</div>
					<!-- Text input-->
						<div class="form-group">
							<div style="margin:15px;">
								<input id="weblink" name="weblink" placeholder="" class="form-control input-md" type="text">
								<span class="help-block">Add a web link </span>  
							</div>
						</div>
					<!-- Button -->
